...
import 'package:t_gadget/loginscreen.dart';
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      if (_formkey.currentState.validate()) {
                        ...
                        Toast.show("Please Check And Fill In All Required Info", context,
  ...
  void _onRegister() async {
    ...
    if (_agree) {
      if (true) {
        ...
        http.post("http://triold.com/tgadget/php/register_user.php", body: {
          "name": _name,
          "email": _email,
          "phone": _phone,
          "password": _pass,
